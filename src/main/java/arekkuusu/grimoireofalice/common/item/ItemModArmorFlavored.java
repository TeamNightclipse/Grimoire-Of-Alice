...
public class ItemModArmorFlavored extends ItemModArmor {

	private final ItemFlavor flavor;

	public ItemModArmorFlavored(ArmorMaterial materialIn, int dmg, String id, EntityEquipmentSlot equipmentSlotIn, ItemFlavor flavor) {
