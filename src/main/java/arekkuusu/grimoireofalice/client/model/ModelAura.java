...
public class ModelAura extends ModelBiped {
	...
	public ModelAura(EntityEquipmentSlot slot) {
		...
		ribbon2 = new ModelRenderer(this, 30, 498);
		ribbon2.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbon2.addBox(-5.3F, -11.5F, 0.0F, 5, 3, 0, 0.0F);
		this.setRotationAngles(ribbon2, 0.0F, 0.08552113334772216F, 0.022689280275926284F);
		ribbon1 = new ModelRenderer(this, 15, 498);
		ribbon1.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbon1.addBox(-7.5F, -11.5F, 0.0F, 6, 3, 0, 0.0F);
		this.setRotationAngles(ribbon1, 0.0F, 0.0F, 0.1308996938995747F);
		ribbon = new ModelRenderer(this, 0, 498);
		ribbon.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbon.addBox(1.5F, -11.5F, 0.0F, 6, 3, 0, 0.0F);
		this.setRotationAngles(ribbon, 0.0F, 0.0F, -0.1308996938995747F);
		ribbon4 = new ModelRenderer(this, 60, 498);
		ribbon4.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbon4.addBox(-9.9F, -11.2F, 0.0F, 6, 3, 0, 0.0F);
		this.setRotationAngles(ribbon4, 0.0F, 0.0715584993317675F, 0.3490658503988659F);
		ribbonBase = new ModelRenderer(this, 90, 498);
		ribbonBase.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbonBase.addBox(-1.0F, -12.2F, 0.0F, 2, 4, 0, 0.0F);
		ribbon5 = new ModelRenderer(this, 75, 498);
		ribbon5.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbon5.addBox(4.1F, -11.2F, 0.0F, 6, 3, 0, 0.0F);
		this.setRotationAngles(ribbon5, 0.0F, -0.0715584993317675F, -0.3490658503988659F);
		ribbon3 = new ModelRenderer(this, 45, 498);
		ribbon3.setRotationPoint(0.0F, 0.0F, 0.0F);
		ribbon3.addBox(0.5F, -11.4F, 0.0F, 5, 3, 0, 0.0F);
