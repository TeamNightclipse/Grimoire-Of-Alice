...
public class GuiScreenBookYoukai extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        int j = 2;
        this.buttonNextPage = (GuiScreenBookYoukai.NextPageButton)this.func_189646_b(new GuiScreenBookYoukai.NextPageButton(1, i + 120, 156, true));
        this.buttonPreviousPage = (GuiScreenBookYoukai.NextPageButton)this.func_189646_b(new GuiScreenBookYoukai.NextPageButton(2, i + 38, 156, false));
        this.updateButtons();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.bookGettingSigned)
        {
            ...
            String s2 = I18n.format("Grimoire of ", new Object[] {this.editingPlayer.getName()});
            ...
            String s3 = I18n.format("This book must be sealed to prevent someone else from reading the scriptures", new Object[0]);
