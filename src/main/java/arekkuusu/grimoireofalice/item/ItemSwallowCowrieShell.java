...
public class ItemSwallowCowrieShell extends ItemMod {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List<String> list, boolean p_77624_4_) {
		list.add(TextFormatting.GOLD + I18n.format("grimoire.tooltip.cowrie_shell_header.name"));
		list.add(TextFormatting.ITALIC + I18n.format("grimoire.tooltip.cowrie_shell_description.name"));
	}
