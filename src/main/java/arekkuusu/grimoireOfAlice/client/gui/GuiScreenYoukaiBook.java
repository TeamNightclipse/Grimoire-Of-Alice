...
public class GuiScreenYoukaiBook extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        byte b0 = 2;
        this.buttonList.add(this.buttonNextPage = new GuiScreenYoukaiBook.NextPageButton(1, i + 120, b0 + 154, true));
        this.buttonList.add(this.buttonPreviousPage = new GuiScreenYoukaiBook.NextPageButton(2, i + 38, b0 + 154, false));
        this.updateButtons();
    }
        ...
        if (this.bookIsUnsigned && this.field_146481_r)
        {
            if (this.bookPages != null)
            {
                ...
                if (p_146462_1_)
                {
                    ...
                    this.bookObj.func_150996_a(GOAItem.itemEnchantedBook);
                }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        if (this.field_146480_s)
        {
            ...
            this.fontRendererObj.drawString(EnumChatFormatting.DARK_RED + s2, k + 36 + (116 - j1) / 2, b0 + 48 + 10, 0);
