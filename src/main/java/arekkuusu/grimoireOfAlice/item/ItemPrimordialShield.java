...
public class ItemPrimordialShield extends ItemSword {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		p_77624_3_.add(EnumChatFormatting.WHITE + "Supermassive unidentified object");
		p_77624_3_.add(EnumChatFormatting.GOLD + "After melting the bases of a");
		p_77624_3_.add(EnumChatFormatting.GOLD + "forgoten universe, an unknown");
		p_77624_3_.add(EnumChatFormatting.GOLD + "entity decided to store the");
		p_77624_3_.add(EnumChatFormatting.GOLD + "remains in the form of a shield");
		p_77624_3_.add(EnumChatFormatting.RED + "Only a god would be able to lift it");
	}
