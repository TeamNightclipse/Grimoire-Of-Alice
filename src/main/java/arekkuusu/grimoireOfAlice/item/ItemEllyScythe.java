...
public class ItemEllyScythe extends ItemSword{
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		...
		p_77624_3_.add(EnumChatFormatting.GOLD
				+ "Oberour ar maro known as the grave");
		p_77624_3_.add(EnumChatFormatting.GOLD
				+ "yard watcher, they said that he");
		p_77624_3_.add(EnumChatFormatting.GOLD
				+ "protects the graveyard and the souls");
		p_77624_3_.add(EnumChatFormatting.GOLD
				+ "around it for some unknown reason and");
		p_77624_3_.add(EnumChatFormatting.GOLD
				+ "collects the lost souls on his land");
	}
