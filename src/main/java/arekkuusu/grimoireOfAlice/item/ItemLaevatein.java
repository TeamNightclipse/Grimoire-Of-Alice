...
public class ItemLaevatein extends ItemSword {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		p_77624_3_.add(EnumChatFormatting.WHITE + "'Damage twig'");
		p_77624_3_.add(EnumChatFormatting.GOLD + "Only true Lolis can wield this sword");
	}
		...
		if(p_77659_3_.experienceLevel > 42) {
			...
			if(!p_77659_2_.isRemote) {
				if(p_77659_3_.capabilities.isCreativeMode || p_77659_3_.inventory.hasItem(Items.fire_charge)) {
					p_77659_2_.playSoundEffect(p_77659_3_.posX + 0.5D, p_77659_3_.posY + 0.5D, p_77659_3_.posZ + 0.5D, "mob.ghast.scream", 1.0F,
							itemRand.nextFloat() * 0.4F + 0.8F);
					Vec3 look = p_77659_3_.getLookVec();
					EntityFireBall fireball2 = new EntityFireBall(p_77659_2_, p_77659_3_, 1, 1, 1);
					fireball2.setPosition(p_77659_3_.posX + look.xCoord * 5, p_77659_3_.posY + look.yCoord * 5, p_77659_3_.posZ + look.zCoord * 5);
