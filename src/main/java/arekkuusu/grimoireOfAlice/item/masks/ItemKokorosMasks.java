...
public class ItemKokorosMasks extends ItemArmor /*implements ISpecialArmor*/ {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		p_77624_3_.add(EnumChatFormatting.DARK_AQUA + "Tsukumogami of Emotions");
		p_77624_3_.add(EnumChatFormatting.GOLD + "Feel the power of 66 masks");
		p_77624_3_.add(EnumChatFormatting.GOLD + "being worn at the same time");
	}
