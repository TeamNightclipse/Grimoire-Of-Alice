...
public class ItemMikoStick extends ItemSword {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		p_77624_3_.add(EnumChatFormatting.WHITE + "Oh look! A stick! Uh-oh...");
		p_77624_3_.add(EnumChatFormatting.GOLD + "Property of Toyosatomimi no Miko");
		p_77624_3_.add(EnumChatFormatting.RED + "Use with caution, its a little");
		p_77624_3_.add(EnumChatFormatting.RED + "hot to the touch");
	}
